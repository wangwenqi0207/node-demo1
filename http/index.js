	...
	*/
	...
	5.设置请求处理函数。
		...
		request ：request是一个请求对象，可以拿到当前浏览器请求的一些信息。
			eg：请求路径，请求方法等
		response： response是一个响应对象，可以用来给请求发送响应，发送的内容。
...
//     .pipe(response) 
// })
// .listen(3000)  //监听本机的3000端口

//node http.js 运行之后
//http://localhost:3000/ 在浏览器里运行 可看到页面hello
//改完以后重启服务


//node服务器读取html页面 网页版石头剪刀布游戏